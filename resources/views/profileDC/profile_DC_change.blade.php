            ...
            <form id="profile" action="/profile-DC/change/set" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="org_type" id="org_type">
                        <option value="{{$dealer['type']}}" selected="selected">{{$dealer['type']}}</option>
                        @if ($dealer['type'] == "ИП")
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="full_name" id="full_name" value="{{$dealer['full_name']}}">
                </div>
                <div class="form-group">
                    <label for="center_tel">Телефон дилерского центра<b>*</b></label>
                    <input type="tel" name="center_tel" id="center_tel" value="{{$dealer['phone_center']}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group small-group">
                    ...
                    <input type="number" name="inn" id="inn" value="{{$dealer['inn']}}">
                </div>
                <div class="form-group small-group">
                    @if ($dealer['type'] == "ООО")
                    <label for="kpp" id="lab_kpp" >КПП (только для ООО)<b id = 'req'>*</b></label>
                    <input type="number" name="kpp" id="kpp" value="{{$dealer['kpp']}}">
                    @else
                        <label for="kpp" id="lab_kpp" >КПП (только для ООО)</label>
                        <input type="number" name="kpp" id="kpp" style="background: #a0a0a0" value="{{$dealer['kpp']}}" disabled>
                    @endif
                </div>
                <div class="form-group small-group">
                    <label for="bik">БИК<b>*</b></label>
                    <input type="number" name="bik" id="bik" value="{{$dealer['bik']}}">
                </div>
                <div class="form-group small-group">
                    <label for="ogrn">ОГРН<b>*</b></label>
                    <input type="number" name="ogrn" id="ogrn" value="{{$dealer['ogrn']}}">
                </div>
                <div class="form-group small-group">
                    <label for="okpo">ОКПО<b>*</b></label>
                    <input type="number" name="okpo" id="okpo" value="{{$dealer['okpo']}}">
                </div>
                <div class="form-group small-group">
                    <label for="okato">ОКАТО<b>*</b></label>
                    <input type="number" name="okato" id="okato" value="{{$dealer['okato']}}">
                </div>

                <div class="form-group">
                    <label for="name_dir">Генеральный директор<b>*</b></label>
                    <input type="text" pattern="[А-Яа-яЁё]"  name="name_dir" id="name_dir" value="{{$dealer['name_director']}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="site_dc" id="site_dc" value="{{$dealer['site_dc']}}">
                </div>
