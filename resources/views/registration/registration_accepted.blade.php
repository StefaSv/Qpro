...
<body>
<section class="section-registration section-login section-request-accepted">
    <div class="container">
        <div class="section-registration__main section-login__main">
            <div class="title">Заявка принята!</div>
            <p>На почту <span>GenDirAuto@workmail.com</span> будет отправлено письмо с Вашим логином и паролем, после
                того как мы добавим Ваш дилерский центр в базу.</p>
